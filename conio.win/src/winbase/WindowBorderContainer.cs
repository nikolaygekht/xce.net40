...
namespace gehtsoft.xce.conio.win
{
    ...
    public class WindowBorderContainer : Window
    {
        ...
        protected WindowBorderContainer(string title, BoxBorder border, ConsoleColor borderColor, bool moveable, bool sizeable)
        {
            mTitle = title;
            mBorder = border;
            mClientArea = null;
        ...
        public WindowBorderContainer(string title, BoxBorder border, ConsoleColor borderColor, Window clientArea, bool moveable, bool sizeable)
        {
            mTitle = title;
            mBorder = border;
            mClientArea = clientArea;
