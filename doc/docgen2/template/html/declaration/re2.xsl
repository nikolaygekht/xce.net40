...
<!-- detect language -->
<table class="decl">
 <tr><td>Report Engine</td></tr>
 <tr><td><code><xsl:value-of select="concat('&amp;lt;', ext:get('name'), ext:get('name-suffix'), '&amp;nbsp;', ext:get('params'), '&amp;gt;', ext:get('suffix'), '&amp;lt;/', ext:get('name'), ext:get('name-suffix'), '&amp;gt;')" disable-output-escaping="yes" /></code></td></tr>
</table>
    </xsl:template>
</xsl:stylesheet>
