...
<table class="decl">
 ...
 <tr><td valign="top" colspan="2"><code><xsl:value-of select="concat(ext:get('prefix'), ext:get('name'), ext:get('name-suffix'), ' ', ext:get('suffix'))" disable-output-escaping="yes" /></code></td></tr>
