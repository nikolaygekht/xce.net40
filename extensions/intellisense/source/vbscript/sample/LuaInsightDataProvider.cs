...
{
    internal class LuaInsightDataProvider : IInsightDataProvider
    {
        LuaPropertyCollection mProps = new LuaPropertyCollection();
        int mStartColumn, mStartRow;
        int mCurSel;
        TextWindow mWindow;
        
        internal LuaInsightDataProvider(TextWindow window, int startRow, int startColumn)
        {
            mCurSel = 0;
            mStartRow = startRow;
        ...
        internal void Add(LuaProperty prop)
        {
            mProps.Add(prop);
        }
