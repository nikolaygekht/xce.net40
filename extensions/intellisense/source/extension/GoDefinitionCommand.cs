...
{
    internal class GoDefinitionCommand : IEditorCommand
    {
        public string Name
        {
            get
            {
                return "Intellisense_GoDefinition";
            }
        }
        ...
        public void Execute(Application application, string param)
        {
            ...
            IProjectBrowserItemCollection collection = provider.FindProjectBrowserItem(application, application.ActiveWindow, out curSel);
