...
{
    internal class ScreenEndCommand : IEditorCommand
    {
        public string Name
        {
            get
        ...
        public void Execute(Application application, string param)
        {
            ...
            {
                application.ActiveWindow.CursorColumn = application.ActiveWindow.TopColumn + application.ActiveWindow.Width - 1;
